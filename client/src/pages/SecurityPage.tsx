...
import { Lock, Shield, KeyRound, ShieldCheck, Timer, Server, ArrowRight } from "lucide-react";
import hubLogo from "@assets/HUB_Logo_(1)_1770930042707.png";

const securityFeatures = [
  { icon: Lock, title: "End-to-End Encryption", description: "All data encrypted in transit and at rest using industry-standard protocols." },
  { icon: Shield, title: "Isolated Sessions", description: "Each app runs in its own sandboxed environment — no cross-contamination." },
  { icon: KeyRound, title: "No Password Storage", description: "We never store your third-party passwords. Your credentials stay yours." },
  { icon: ShieldCheck, title: "Secure Authentication", description: "Session-based auth with httpOnly secure cookies for maximum protection." },
  { icon: Timer, title: "Rate Limiting", description: "Built-in protection against brute force attacks and suspicious activity." },
  { icon: Server, title: "Bank-Grade Infrastructure", description: "Enterprise PostgreSQL with encrypted connections and automated backups." },
];
        ...
        <div className="max-w-5xl mx-auto text-center space-y-8">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-display font-bold text-white tracking-tight leading-[1.1] mb-6">
              Your Security is<br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-white/80 to-white/40">Our Priority.</span>
            </h1>
            <p className="text-xl text-white/40 max-w-2xl mx-auto leading-relaxed">
              Built from the ground up with enterprise-grade security. Your data, your sessions, your passwords — always protected.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pt-16 text-left"
          >
          ...
          >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {stats.map((stat, i) => (
                ...
                >
                  <p className="text-3xl font-display font-bold text-[#EF4444] mb-1">{stat.value}</p>
          ...
          >
            <h2 className="text-3xl md:text-4xl font-display font-bold text-white mb-4">
              Experience Secure Productivity
            </h2>
            <p className="text-lg text-white/40 max-w-xl mx-auto mb-8">
              Join thousands of professionals who trust HUB with their daily workflow.
            </p>
            <Button
              size="lg"
